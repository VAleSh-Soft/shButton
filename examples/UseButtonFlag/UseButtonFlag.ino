 ...
 */
#define USE_BUTTON_FLAG // объявляем, что намерены использовать пользовательские флаги кнопок; обязательно задавать перед объявлением файла shButton.h
#include <shButton.h>
...
// пользовательские флаги для использования с кнопкой; назначаются на ваше усмотрение в соответствие с логикой вашей программы
...
void setup()
{
  btn.setVirtualClickOn();            // включаем режим виртуального клика, т.к. нам нужно отрабатывать реакцию на одиночный, двойной клик и удержание кнопки нажатой
