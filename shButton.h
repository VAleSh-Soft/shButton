...
public:
  ...
  // shButton btn(); - без привязки к конкретному пину - режим виртуальной кнопки
  shButton(byte pin = NO_PIN, byte inputtype = PULL_UP, byte btntype = BTN_NO);
