 ...
 * во избежание ошибок компиляции определения методов библиотеки перенесены в заголовочный файл, при этом файл **shButton.cpp** был удален; теперь библиотека состоит из одного заголовочного файла **shButton.h**;
