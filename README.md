  ...
  - Работа с виртуальной кнопкой, т.е. кнопкой, не привязанной к конкретному пину, например - кнопки аналоговой, матричной клавиатуры или или кнопки, подключенные через расширители портов;
